        ...
        <section className='mt-[5px]'>
            ...
            <div className='absolute w-full bottom-[5rem]'>
                ...
                <div className='flex justify-center items-center gap-[15rem]'>
                    ...
                    <Link to='/home'><button className='text-[25px] w-[20rem] h-[2.9rem] rounded-xl bg-[black] text-[white] hover:text-[green] duration-[0.4s]' type="button">Start Exploring</button></Link>
                </div>
            </div>
        </section>
    )
